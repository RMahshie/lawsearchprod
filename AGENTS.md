...
For complex features, refactors, migrations, or ambiguous multi-file changes, create an Execution Plan using `.agent/PLANS.md`.

Create task-specific plans under `.agent/plans/`.
