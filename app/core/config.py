...
FY2026_ROUTING_ALIASES = {
    ...
    "COMMERCE, JUSTICE, SCIENCE, AND RELATED AGENCIES": "CJS, Commerce, DOJ, Justice, Office of Justice Programs, OJP, Byrne JAG, State and Local Law Enforcement Assistance, Community Oriented Policing Services, COPS, police hiring, community violence intervention, police-community relations, de-escalation training, cybercrimes against individuals, judicial security grants, FBI, DEA, ATF, prisons, NASA, NSF, NOAA, Census, NIST, science agencies.",
    "ENERGY AND WATER DEVELOPMENT AND RELATED AGENCIES": "Energy and Water, Department of Energy, DOE, Departmental Administration, Office of Inspector General, Corps of Engineers, Bureau of Reclamation, water projects, water storage, rural water supply, Reclamation rural water program, hydropower, hydroelectric facilities, nuclear security, NNSA, atomic energy defense, energy efficiency, renewable energy, cybersecurity, energy security, emergency response, grid deployment, power marketing administrations, FERC.",
    "DEPARTMENT OF THE INTERIOR, ENVIRONMENT, AND RELATED AGENCIES": "Interior, DOI, EPA, environment, water infrastructure, rural water infrastructure, drinking water, wastewater, water and sewer, Drinking Water State Revolving Fund, Clean Water State Revolving Fund, WIFIA, water infrastructure grants, public lands, National Park Service, Bureau of Land Management, Fish and Wildlife, Indian Affairs, Forest Service, Smithsonian.",
    ...
    "TRANSPORTATION, HOUSING AND URBAN DEVELOPMENT, AND RELATED AGENCIES": "THUD, Transportation, DOT, FAA, Federal Aviation Administration, Grants-In-Aid for Airports, airport planning and development, airport grants, Federal Highway Administration, Federal-aid Highways, highways, Federal Transit Administration, transit formula grants, transit, rail, maritime, transportation safety, HUD, housing, rental assistance, tenant-based rental assistance, project-based rental assistance, public housing, Homeless Assistance Grants, homelessness assistance, Section 811 supportive housing, supportive housing, community development, CDBG.",
    ...
    "CONTINUING APPROPRIATIONS, EXTENDERS, HOMELAND SECURITY, AND OTHER MATTERS": "CR, continuing resolution, continuing appropriations, regular appropriations, regular versus continuing appropriations, regular vs continuing, full-year vs continuing, CR mechanism, rate for operations, rate-for-operations, apportionment authority, prior-law authority, temporary funding, extensions, extenders, technical corrections, Homeland Security, DHS, FEMA, cybersecurity, E-Verify, H-2B, National Flood Insurance Program, NFIP, health care extenders, Medicare extenders, Medicaid extenders, VA extenders, other matters.",
}
