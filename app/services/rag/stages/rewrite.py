...
_REWRITE_SYSTEM_PROMPT = (
    ...
    "For questions aimed at cities, States, Tribes, or other eligible recipients, include likely "
    "flexible block, formula, and competitive grant headings as well as narrowly named programs. "
    "For each distinct need, include the major parallel delivery lanes instead of stopping after "
    "the first matching heading. "
    ...
    "Within each query, separate distinct account, program, authority, and statutory-heading phrases "
    "with semicolons. Keep each phrase intact; do not run one heading into the next. "
